  ...
  constructor: ->
    @_GLOBALS_DEFAULTS = {
      defaults: {
        ...
        ROLLBAR_SOURCEMAPS_URL_PREFIX: "https://synthesizer.com"
        ...
        # TESTFAIRY_TESTER_GROUPS: "synthesizerTesters"
      ...
      development: {
        ...
        BUNDLE_ID: "com.jtomaszewski.synthesizer.development"
        BUNDLE_NAME: "synthesizerDev"
      ...
      production: {
        ...
        BUNDLE_ID: "com.jtomaszewski.synthesizer.production"
        BUNDLE_NAME: "synthesizer"

        COMPRESS_ASSETS: true

        # If those 2 variables are defined, the app will be deployed to the remote server after compiling the release.
        # ANDROID_DEPLOY_APPBIN_PATH: "deploy@synthesizer.com:/u/apps/synthesizer/shared/public/uploads/synthesizer-production.apk"
        # ANDROID_DEPLOY_APPBIN_URL: "http://synthesizer.com/uploads/synthesizer-production.apk"

        # If those 2 variables are defined, the app will be deployed to the remote server after compiling the release.
        # IOS_DEPLOY_APPBIN_PATH: "deploy@synthesizer.com:/u/apps/synthesizer/shared/public/uploads/synthesizer-production.ipa"
        # IOS_DEPLOY_APPBIN_URL: "http://synthesizer.com/uploads/synthesizer-production.ipa"

        # Required for the release to be signed with correct certificate.
        IOS_PROVISIONING_PROFILE: "keys/ios/synthesizerstaging.mobileprovision"

        # CORDOVA_GOOGLE_ANALYTICS_ID: "UA-123123-2"
        # GOOGLE_ANALYTICS_ID: "UA-123123-1"
        # GOOGLE_ANALYTICS_HOST: "synthesizer.com"
      }
    }
    ...
    @PATHS = {
      ...
      scripts:
        vendor: [
          ...
          "assets/components/timbre.js/timbre.dev.js"
